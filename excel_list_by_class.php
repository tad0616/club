...
$i = 1;
$n = 0;
foreach ($stus as $stu_grade => $stu_grade_arr) {
    foreach ($stu_grade_arr as $stu_class => $stu_class_arr) {
        foreach ($stu_class_arr as $stu_seat_no => $stu) {
            $i++;
            $objActSheet->setCellValue("A{$i}", $stu['club_year'])
                ->setCellValue("B{$i}", $stu['club_seme'])
                ...
                ->setCellValue("G{$i}", $stu['club_title']);
            if ($n % 2) {
...
foreach ($stus as $stu_grade => $stu_grade_arr) {
    foreach ($stu_grade_arr as $stu_class => $stu_class_arr) {
        ...
        $objActSheet->setTitle("{$stu_grade}-{$stu_class}"); //設定標題
